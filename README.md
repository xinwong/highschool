...
$$
\begin{equation}
    \vx'_{i}=\underbrace{\left(\mathbf{1}-M_{p, i}\right) \circ \vx_{i}}_{\text{A}}+\underbrace{M_{p, i} \circ \vx_{i}}_{\text{B}}-\underbrace{M_{c, i} \circ \vx_{i}}_{\text{C}}+\underbrace{M_{c, i} \circ \bm{\delta}}_{\text{D}},
\end{equation}
$$
